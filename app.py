...
password = quote_plus('Shahid@12345#')  # URL-encode the password
app.config['SQLALCHEMY_DATABASE_URI'] = f'mysql+mysqlconnector://root:{password}@localhost:3306/COMPANY_ASSIGNMENT_ONE'
...
def upload_file():
    ...
    if file and file.filename.endswith('.xlsx'):
        ...
        # file_path = r"C:\Users\user\Desktop\Placement_Assignment\empdata.xlsx"
        file_path = os.path.join(app.root_path, 'uploads', 'empdata.xlsx')
